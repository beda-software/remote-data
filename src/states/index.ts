...
export function isLoadingAny(responses: RemoteData[]): responses is RemoteDataLoading[] {
    return responses.some(isLoading)
}

export function isNotAskedAny(responses: RemoteData[]): responses is RemoteDataNotAsked[] {
